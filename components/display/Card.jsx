...
/* interactive: true raises the shadow AND washes the surface; 'shadow' raises
   the shadow alone, for a card whose only click target is a control inside it.
   Pair 'shadow' with variant="flat" for a card that rests flat on a surface
   that already carries the shadow. */
