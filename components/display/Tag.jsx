...
const SOLID={pink:['var(--accent-pink)','#fff'],coral:['var(--accent-coral)','#fff'],orange:['var(--accent-orange)','var(--ink-900)'],yellow:['var(--accent-yellow)','var(--ink-900)'],lime:['var(--accent-lime)','var(--ink-900)'],teal:['var(--accent-teal)','var(--ink-900)'],cyan:['var(--accent-cyan)','var(--ink-900)'],navy:['var(--accent-navy)','#fff'],lilac:['var(--tint-lilac)','var(--ink-900)'],ink:['var(--ink-900)','#fff']};
const SOFT={pink:['var(--accent-pink-soft)','#A31257'],coral:['var(--accent-coral-soft)','#A8371E'],orange:['var(--accent-orange-soft)','#8F4C00'],yellow:['var(--accent-yellow-soft)','#8A6300'],lime:['var(--accent-lime-soft)','#4F6D0E'],teal:['var(--accent-teal-soft)','#0B6E6E'],cyan:['var(--accent-cyan-soft)','#106A85'],navy:['var(--accent-navy-soft)','var(--accent-navy)'],lilac:['var(--tint-lilac-soft)','var(--violet-800)'],ink:['var(--surface-quiet)','var(--gray-700)']};
